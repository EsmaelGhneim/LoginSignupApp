...
public class LoginFragment extends Fragment {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.trim().isEmpty() && password.trim().isEmpty()) {
                    Toast.makeText(getActivity(), "some fields are empty jr", Toast.LENGTH_SHORT).show();
                    return;
                }


                // Login procedure
                //something missing, watch the login video on 35:50
    ...
    private void gotoSignupFragment() {
        ...
        ft.replace(R.id.frameLyoutMain, new SignupFragment());
        ft.commit();
    }
}